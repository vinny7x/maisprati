...
console.log("Shakspeare said, 'To be or not to be'");
console.log('Shakspeare said, "To be or not to be"');
...
// Métodos de string
let frase = "Senhor dos Anéis é fantastico!";

console.log(frase.toUpperCase()); // "SENHOR DOS ANÉIS É FANTASTICO!" (tudo em maiúsculas)
console.log(frase.toLowerCase()); // "senhor dos anéis é fantastico!" (tudo em minúsculas)
...
// Trabalhando com condicionais (if, else if, else)
let nota = 10
let nota2 = 10
...
// Recuperando input do usuário (exercício)
